...
while True:
    ...
    score_text = font.render("Score [Press A]" + str(playerOne.point), 0, (255, 255, 120))
    fireNum = font.render("Shots [Press S]" + str(fires), 0, (255, 255, 120))
    zoomNum = font.render("Zoomings [Press D]" + str(zoomings), 0, (255, 255, 120))
